...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"name": "Support", "url": "https://t.me/siddiqov_bobur/", "new_window": True},
    ...
    "icons": {
        ...
        "app.Article": "fas fa-user-tie",
        "app.Bookbaza": "fas fa-list",
        "app.Book": "fas fa-list-alt",
        "app.Certificate": "fas fa-shopping-basket",
        "app.Dgubaza": "fas fa-file",
        "app.Dissertationbaza": "fas fa-history",
        'app.Dissertation': 'fas fa-comment-dots',
        "app.Faq": "fas fa-shopping-bag",
        "app.Maqolabaza": "fas fa-money-bill-wave",
